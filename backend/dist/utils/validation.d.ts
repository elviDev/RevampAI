...
export declare const ChannelTypeSchema: import("@sinclair/typebox").TUnion<[import("@sinclair/typebox").TLiteral<"general">, import("@sinclair/typebox").TLiteral<"project">, import("@sinclair/typebox").TLiteral<"department">, import("@sinclair/typebox").TLiteral<"announcement">, import("@sinclair/typebox").TLiteral<"private">]>;
